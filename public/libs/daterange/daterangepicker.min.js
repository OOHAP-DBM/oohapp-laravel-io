...
setEndDate: function (endDate) {
    ...
    if (!this.timePicker) {
        this.endDate = this.endDate.startOf('day').add(1, 'day').subtract(1, 'second');
    }
...
// Update the Code End
        ...
        //     console.log('update view Start date', this.startDate.format(this.locale.format),'end date', this.endDate.format(this.locale.format));
        ...
        updateView: function() {
            ...
            if (this.isShowing) {
                this.isShowing = false;
                this.container.hide();
                this.element.trigger('hide-calendar', this); // For external event handling
            }
        
            // Update the input or display element
            this.updateElement();
        },
        ...
        updateCalendars: function() {
            // If time picker is enabled, set the time for start and end dates
            if (this.timePicker) {
                var hour, minute, second;
        
                // Check if endDate exists to set the appropriate time
                if (this.endDate) {
                ...
                // Set hour, minute, and second for left and right calendars
                this.leftCalendar.month.hour(hour).minute(minute).second(second);
                this.rightCalendar.month.hour(hour).minute(minute).second(second);
            }
        
            // Calculate end date automatically if a start date is selected
            if (this.startDate) {
                // Add 7 days to the start date to auto-set the end date
            ...
            // Calculate the chosen label if any
            this.calculateChosenLabel();
        
            // Trigger an event to indicate the calendar has been updated
            if(this.isShowing){
                console.log('Update calendars', this.startDate, this.endDate);
