<?php
    ...
    class Flight extends Bookable
    {
        ...
        public function getScoreReview()
        {
            ...
            $list_score['review_text'] = $list_score['score_total'] ? Review::getDisplayTextScoreByLever(round($list_score['score_total'])) : __("Not rated yet");
            return $list_score;
        }
        ...
        public static function search(Request $request)
        {
            ...
            if (is_array($terms) and !empty($terms = array_filter($terms))) {
                $model_flight->select("bravo_flight.*");
