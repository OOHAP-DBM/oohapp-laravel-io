...
<form class="bravo-form-login" method="POST" action="{{ route('login') }}">
    ...
    <div class="form-group">
        <input type="text" class="form-control" name="email" style="padding: 0.375rem 1.75rem;" autocomplete="off" placeholder="&nbsp;&nbsp;&nbsp;{{__('Email address')}}">
        <i class="input-icon ss icofont-mail"></i>
        <span class="invalid-feedback error error-email"></span>
    </div>
    <div class="form-group">
        <input type="password" class="form-control" name="password" style="padding: 0.375rem 1.75rem;" autocomplete="off"  placeholder="&nbsp;&nbsp;&nbsp;{{__('Password')}}">
