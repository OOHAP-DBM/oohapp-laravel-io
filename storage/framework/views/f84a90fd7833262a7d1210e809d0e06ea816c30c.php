<div class="form-checkout" id="form-checkout" >
        ...
        <div class="row">
            ...
            <div class="col-md-6 field-email">
                <div class="form-group">
                    ...
                    <input type="email" placeholder="<?php echo e(__("email@domain.com")); ?>" id="Xemail" class="form-control" value="<?php echo e($user->email ?? ''); ?>" name="email">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label ><?php echo e(__("Phone")); ?> <span class="required">*</span></label>
                    <input type="text" placeholder="<?php echo e(__("Your Phone")); ?>" class="form-control" id="Xphone" value="<?php echo e($user->phone ?? ''); ?>" name="phone">
                </div>
            </div>
    ...
    <div style="display:none" id="moneyforPaid" totalamount="<?php echo e(format_money($booking->total - $booking->paid)); ?>"></div>
    ...
    <div class="form-group">
        <label class="term-conditions-checkbox">
            <input type="checkbox" name="term_conditions"> <?php echo e(__('I have read and accept the')); ?>  <a target="_blank" href="/page/privacy-policy"><?php echo e(__('terms and conditions')); ?></a>
        </label>
    </div>
    ...
    <div class="form-actions " id="exceptrazorpay">
    ...
    <div class="form-actions " id="includerazorpay" style="display:none;">
        <button class="btn btn-danger " id="buttonRazorpay" >razorpay
            <i class="fa fa-spin fa-spinner" v-show="onSubmit"></i>
        </button>
    </div>
    
</div>
<?php /**PATH G:\xampp\htdocs\oohapp-laravel-io\themes/BC/Booking/Views/frontend/booking/checkout-form.blade.php ENDPATH**/ ?>