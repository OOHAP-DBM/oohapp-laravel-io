<?php if(!empty($field['attr']) and !empty($attr = \Modules\Core\Models\Attributes::find($field['attr']))): ?>
    ...
    <?php if($attr): ?>
        <div class="filter-item">
            <div class="form-group">
                ...
                <img style="height:20px;width:20px;margin:8px;" src="<?php echo e(asset('images/all category.jpg')); ?>">
                <div class="form-content" style="margin-top:-36px;">
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\oohapp-laravel-io\themes/BC/Space/Views/frontend/layouts/search-map/fields/attr.blade.php ENDPATH**/ ?>