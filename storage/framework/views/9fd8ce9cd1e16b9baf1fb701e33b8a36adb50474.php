...
.dropdown-notifications {
    ...
    background: #dfd6d6;
    margin-top:35%;
    box-shadow: 4px 3px 4px 0px darkgrey;
    margin-left: -43px;
}
...
.fixed {
 ...
 <div class="bravo_header sticky">
     <div class="<?php echo e($container_class ?? 'container'); ?>">
        <div class="content">
            
         <div class="container-fluid hideformobile">
            ...
            <div class="">
                ...
                <div class="" >
    <div class="">
        <div class="content" style="right: -719px;
    position: relative;
}">
            ...
            <div class=>
                ...
                <?php if(!Auth::check()): ?>
                               ...
                               <a href="#login" data-toggle="modal" data-target="#login" class="login btn btn-primary" style="background:black;"><?php echo e(__('Login')); ?></a>
                        
                        <?php if(is_enable_registration()): ?>
                           
                                <a href="https://oohapp.io/register"  class="signup btn btn-primary" style="background:black;"><?php echo e(__('Sign Up')); ?></a>
                    ...
                    <li class="dropdown" >
                            <a href="#" data-toggle="dropdown" class="userdropdowned" style="" class="login"><?php echo e(__("Hi, :name",['name'=>Auth::user()->getDisplayName()])); ?>
            ...
            <div class="header-right" style="width:100%;">
                <?php if(!empty($header_right_menu)): ?>
                    <ul class="topbar-items">
                        ...
                        <?php if(!Auth::check()): ?>
                            <!--<li class="login-item">-->
                            <!--    <a href="#login" data-toggle="modal" data-target="#login" class="login btn btn-primary" style="float:left; background:black;color:white; margin-top:20px; border-radius:10px; margin-right:-30px;"><?php echo e(__('Login')); ?></a>-->
                            <!--</li>-->
                            <?php if(is_enable_registration()): ?>
                                <!--<li class="signup-item">-->
                                <!--    <a href="#register" data-toggle="modal" data-target="#register" class="signup btn btn-primary" style="float:left; background:black;color:white; margin-top:20px;border-radius:10px;"><?php echo e(__('Sign Up')); ?></a>-->
                                <!--</li>-->
                            <?php endif; ?> 
                ...
                <button class="bravo-more-menu">
                  <img src="<?php echo e(asset('images/dots.png')); ?>" style="height: 34px;
    rotate: 90deg;
    margin-top: -10px;">
                </button>
            </div>
...
<?php /**PATH C:\Users\DBM PC\Documents\GitHub\oohapp-laravel-io\modules/Layout/parts/header.blade.php ENDPATH**/ ?>