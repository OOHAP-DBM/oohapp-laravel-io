...
<form class="form bravo-form-register" method="post" action="<?php echo e(route('auth.register.store')); ?>">
    ...
    <div class="row">
        <div class="col-lg-6 col-md-12">
            <div class="form-group">
                <input type="text" class="form-control" name="first_name" autocomplete="off" style="padding: 0.375rem 1.75rem;" placeholder="&nbsp;&nbsp;&nbsp;<?php echo e(__("First Name")); ?>">
        ...
        <div class="col-lg-6 col-md-12">
            <div class="form-group">
                <input type="text" class="form-control" name="last_name" autocomplete="off" style="padding: 0.375rem 1.75rem;" placeholder="&nbsp;&nbsp;&nbsp;<?php echo e(__("Last Name")); ?>">
                <i class="input-icon field-icon ss icofont-waiter-alt"></i>
    ...
    <div class="form-group">
        <input type="text" class="form-control" name="phone" autocomplete="off" style="padding: 0.375rem 1.75rem;" placeholder="&nbsp;&nbsp;&nbsp;<?php echo e(__('Phone')); ?>">
...
<?php /**PATH C:\xampp\htdocs\oohapp.io_8thnov2023\modules/Layout/auth/register-form.blade.php ENDPATH**/ ?>