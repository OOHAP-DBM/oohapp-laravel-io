                    ...
                    <?php if($booking->status !='draft'): ?>
                        ...
                        <?php if($booking->paid < $booking->total ): ?>
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="val moneyforPaid" ><?php echo e(format_money($booking->total - $booking->paid)); ?></div>
                            </div>
                        <?php endif; ?>
                    <?php endif; ?>
                </li>
...
<?php /**PATH G:\xampp\htdocs\oohapp-laravel-io\themes/BC/Space/Views/frontend/booking/detail.blade.php ENDPATH**/ ?>