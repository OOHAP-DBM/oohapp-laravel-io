        ...
        <div class="form-content">
            <?php if($location_search_style=='autocompletePlace'): ?>
                <div class="g-map-place">
                    <input type="text" name="map_place" placeholder="<?php echo e(__("find your hoarding !!")); ?>"
            ...
            <?php else: ?>
                ...
                <div class="smart-search">
                    <input type="text" class="smart-search-location parent_text form-control"
                           <?php echo e(( empty(setting_item("space_location_search_style")) or setting_item("space_location_search_style") == "normal" ) ? "readonly" : ""); ?> placeholder="<?php echo e(__("Find your hoarding !!s")); ?>"
...
<?php /**PATH C:\xampp\htdocs\oohapp-laravel-io\themes/BC/Space/Views/frontend/layouts/search-map/fields/location.blade.php ENDPATH**/ ?>