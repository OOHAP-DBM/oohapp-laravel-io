    ...
    <div class="panel-body">
        ...
        <?php endif; ?>
         <!-- </div> -->
           ...
           <div class="col-md-6">  <label class="control-label"><?php echo e(__("Zip Code")); ?></label>
             <input type="number" name="zip_code" id="zip_code" class="form-control" placeholder="<?php echo e(__("zip_code")); ?>" value="<?php echo e($row->zip_code); ?>">
        </div>
        </div>
                        </div>             
        <div class="form-group">
...
<?php /**PATH C:\xampp\htdocs\oohapp-laravel-io\modules/Space/Views/admin/space/location.blade.php ENDPATH**/ ?>