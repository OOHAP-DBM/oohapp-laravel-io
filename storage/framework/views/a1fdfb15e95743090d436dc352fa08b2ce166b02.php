        ...
        <div class="price-wrapper">
            <div class="price">
                ...
                <span class="text-price">
                    ...
                    <?php if($row->getBookingType()=="by_day"): ?>
                        <span class="unit"><?php echo e(__("Min. Spend")); ?></span>
                    <?php else: ?>
                        <span class="unit"><?php echo e(__("Min. Spend")); ?></span>
                    <?php endif; ?>
                </span>
...
<?php /**PATH C:\Users\DBM PC\Documents\GitHub\oohapp-laravel-io\themes/BC/Space/Views/frontend/layouts/search/loop-grid.blade.php ENDPATH**/ ?>