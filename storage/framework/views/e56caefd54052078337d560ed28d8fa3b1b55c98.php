                ...
                <div class="card-header">
                    <h4 class="mb-0">
                        <label class="" data-toggle="collapse" data-target="#gateway_<?php echo e($k); ?>" >
                            <input type="radio" id="<?php echo e($k); ?>" name="payment_gateway" value="<?php echo e($k); ?>">
...
<?php /**PATH G:\xampp\htdocs\oohapp-laravel-io\themes/BC/Booking/Views/frontend/booking/checkout-payment.blade.php ENDPATH**/ ?>