<div class="panel">
    ...
    <div class="panel-body">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="form-group">
                    <label class="control-label"><?php echo e(__('Hoarding Type')); ?></label>
                    <div>
                        <select name="hoarding_type" class="form-control" required>
                            <option value=""><?php echo e(__('-- Please Select --')); ?></option>
                            <option value="1" <?php echo e($row->hoarding_type == 1 ? 'selected' : ''); ?>><?php echo e(__('OOH')); ?>

                            </option>
                            <option value="2" <?php echo e($row->hoarding_type == 2 ? 'selected' : ''); ?>><?php echo e(__('DOOH')); ?>
        ...
        <div class="control-label"><strong><?php echo e(__('Hoarding Size')); ?></strong></div>
        <div class="row">
            <div class="col-lg-3">
                <div class="form-group">
            ...
            <div class="col-lg-3">
                <div class="form-group">
                    <label class="control-label"><?php echo e(__('Width')); ?></label>
            ...
            <div class="col-lg-3">
                <div class="form-group">
                    <label class="control-label"><?php echo e(__('Height')); ?></label>
            ...
            <div class="col-lg-3">
                <div class="form-group">
                    <label class="control-label"><?php echo e(__('Size Preview')); ?></label>
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="form-group">
                    <label class="control-label"><?php echo e(__('Ooh Daily Traffic')); ?></label>
            ...
            <div class="col-lg-3">
                <div class="form-group">
                    <label class="control-label"><?php echo e(__('Angle of Visibility')); ?></label>
                    <div class="">
            ...
            <div class="col-lg-3">
                <div class="form-group">
                    <label class="control-label"><?php echo e(__('Illumination')); ?></label>
                    <div class="">
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="form-group">
                    <label class="control-label"><?php echo e(__('Approved from Nagar Nigam ?')); ?></label>
                    <div>
                        <label>
            ...
            <div class="col-lg-3">
                <div class="form-group">
                    <label class="control-label"><?php echo e(__('Grace period includes in your booking')); ?></label>
                    <div>
                        <label>
        ...
        <div class="control-label"><strong><?php echo e(__('Hoarding Validity')); ?></strong></div>
        <div class="row">
            <div class="col-lg-3">
                <div class="form-group">
                    <label class="control-label"><?php echo e(__('Valid till')); ?></label>
            ...
            <div class="col-lg-3">
                <div class="form-group">
                    <label class="control-label"><?php echo e(__('Booking Duration')); ?></label>
                    <div>
        ...
        <div class="form-group">
            ...
            <input type="text" value="<?php echo clean($translation->title); ?>" placeholder="<?php echo e(__('Name of the space')); ?>"
                ...
                <?php if(!empty($translation->faqs)): ?>
                    ...
                    <?php $__currentLoopData = $translation->faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="item" data-number="<?php echo e($key); ?>">
                            <div class="row">
                                <div class="col-md-5">
                                    <input type="text" name="faqs[<?php echo e($key); ?>][title]"
                                        class="form-control" value="<?php echo e($faq['title']); ?>"
                                        placeholder="<?php echo e(__('Eg: When and where does the tour end?')); ?>">
                                </div>
                                <div class="col-md-6">
...
<?php /**PATH G:\xampp\htdocs\oohapp-laravel-io\modules/Space/Views/admin/space/content.blade.php ENDPATH**/ ?>