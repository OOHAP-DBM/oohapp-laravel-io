...
<?php $__env->startSection('content'); ?>
    <h2 class="title-bar">
        <?php echo e(!empty($recovery) ?__('Recovery Spaces') : __("Manage Hoardings")); ?>

        <?php if(Auth::user()->hasPermission('space_create')&& empty($recovery)): ?>
            <a href="<?php echo e(route("space.vendor.create")); ?>" class="btn-change-password"><?php echo e(__("Add Hoarding")); ?></a>
        <?php endif; ?>
    </h2>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\oohapp-laravel-io\themes/BC/Space/Views/frontend/manageSpace/index.blade.php ENDPATH**/ ?>