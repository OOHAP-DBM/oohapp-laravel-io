...
<form class="bravo-form-login" method="POST" action="<?php echo e(route('login')); ?>">
    ...
    <div class="form-group">
        <input type="text" class="form-control" name="email" style="padding: 0.375rem 1.75rem;" autocomplete="off" placeholder="&nbsp;&nbsp;&nbsp;<?php echo e(__('Email address')); ?>">
        <i class="input-icon ss icofont-mail"></i>
        <span class="invalid-feedback error error-email"></span>
    </div>
    <div class="form-group">
        <input type="password" class="form-control" name="password" style="padding: 0.375rem 1.75rem;" autocomplete="off"  placeholder="&nbsp;&nbsp;&nbsp;<?php echo e(__('Password')); ?>">
...
<?php /**PATH C:\xampp\htdocs\oohapp.io_8thnov2023\modules/Layout/auth/login-form.blade.php ENDPATH**/ ?>