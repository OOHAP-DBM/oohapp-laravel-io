    ...
    <div class="form-content">
        ...
        <?php if($location_search_style=='autocompletePlace'): ?>
            <div class="g-map-place" >
                <input type="text" name="map_place" placeholder="<?php echo e(__("Find Your Hoarding !!")); ?>"  value="<?php echo e(request()->input('map_place')); ?>" class="form-control border-0">
...
<?php /**PATH C:\Users\DBM PC\Documents\GitHub\oohapp-laravel-io\themes/BC/Space/Views/frontend/layouts/search/fields/location.blade.php ENDPATH**/ ?>